              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "w-full justify-center" }, [
                    _vm.$page.site.logo !== undefined
                      ? _c("img", {
                          staticClass: "object-cover m-auto object-center",
                          attrs: { src: _vm.$page.site.logo }
                        })
                      : _vm._e(),
                    _vm._v(" "),
                    _vm.$page.site.logo === undefined
                      ? _c(
                          ...
                          [_vm._v(_vm._s(_vm.$page.site.name))]
                        )
                      : _vm._e()
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "w-full" }, [
                    _c(
                      ...
                      {
                        staticClass:
                          "font-medium tracking-wider leading-relaxed text-center mt-3 mb-5"
                      },
                      [_vm._v(_vm._s(_vm.__(_vm.$page.site.welcome)))]
                    ),
                    _vm._v(" "),
                    _c(
                      "form",
